...
class invoicr extends FPDF_rotation 
{
	...
	*                                                                              *
	*******************************************************************************/
	// Modern PHP constructor (PHP 8.2 compatible)
	function __construct($size='A4',$currency='€',$language='en')
	{
		...
		$this->setColor("#78c046");
		
		// Call parent constructor (FPDF uses old-style constructor)
	...
	*******************************************************************************/
	function Header()
	{
		...
		if($this->PageNo()==1) 
		{
			// Fix for PHP 8.2 - ensure dimensions is set
			if(!is_array($this->dimensions)) $this->dimensions = array(0,0);
